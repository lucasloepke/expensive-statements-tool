...
def execute_expensive_statements(path):
    print("Starting Analysis")

    file_name = path + 'test_statements.csv'
    ...
    file_name = path + 'test_actions.csv'
    ...
    # Update summary_out_fule to server path + 'summary.xml'
    with pd.ExcelWriter('test_summary.xlsx', engine='openpyxl') as writer:
